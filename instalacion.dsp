...
acelerometroFrecuency= hslider("acelerometroFrecuency[acc: 0 0 -10 0 10]",0,-3000, 5000,1) : si.smoo; 
...
/////////////////////////////////////////////////////////////////////
//main
main = _: (analizador,acelerometroFrecuency: + : inRange) ~ (recursividad) ; 

process = _: main : os.osc*play*acelerometroAmplitud;
